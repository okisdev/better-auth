...
If the user is not authenticated, they will be redirected to the `loginPage` specified in your plugin configuration. After successful authentication, they will be redirected back to complete the authorization.
